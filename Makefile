...
test_scene_json: test_scene_json.c scene_json.c test_stubs.c cJSON.c
	gcc $(CFLAGS) test_scene_json.c scene_json.c test_stubs.c cJSON.c -lm -o test_scene_json
